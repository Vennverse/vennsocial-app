...
import com.spacester.myfriend.live.activities.RtcBaseActivity;
import com.spacester.myfriend.live.stats.LocalStatsData;
import com.spacester.myfriend.live.stats.RemoteStatsData;
import com.spacester.myfriend.live.stats.StatsData;
import com.spacester.myfriend.live.ui.VideoGridContainer;
...
public class PodcastActivity extends RtcBaseActivity {
    ...
    private void initUI() {
         ...
         role = getIntent().getIntExtra(
                 com.spacester.myfriend.live.Constants.KEY_CLIENT_ROLE,
        ...
        rtcEngine().setBeautyEffectOptions(beautyBtn.isActivated(),
                com.spacester.myfriend.live.Constants.DEFAULT_BEAUTY_OPTIONS);
    ...
    private void initData() {
        mVideoDimension = com.spacester.myfriend.live.Constants.VIDEO_DIMENSIONS[
